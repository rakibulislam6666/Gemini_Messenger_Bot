...
Supporters:
%2`,
    "notHavePermssion": '[ADMIN MODE] You do not have permission to use the function "%1".',
    "addedNewAdmin": '[ADMIN MODE] Successfully added %1 user(s) as Admin.\n\n%2',
    "addedNewNDH": '[ADMIN MODE] Successfully added %1 user(s) as Supporter.\n\n%2',
    "removedAdmin": '[ADMIN MODE] Successfully removed %1 Admin(s), reverted to member role.\n\n%2',
    "removedNDH": '[ADMIN MODE] Successfully removed %1 Supporter(s), reverted to member role.\n\n%2'
}
...
• admin list       → View the list of all Admins and Supporters.
• admin add        → Add a user as Admin.
• admin remove     → Remove a user from Admin role.
• admin addndh     → Add a user as Supporter.
• admin removendh  → Remove a user from Supporter role.
• admin qtvonly    → Enable/Disable mode: Only Admins can use the bot.
• admin ndhonly    → Enable/Disable mode: Only Supporters can use the bot.
• admin only       → Enable/Disable mode: Only Admins can use the bot.
• admin ibonly     → Enable/Disable mode: Only Admins can use the bot in inbox separately.

━━━━━━━━━━━━━━━
HELP TIP: Use "${global.config.PREFIX}admin [command]" to execute a command.`
