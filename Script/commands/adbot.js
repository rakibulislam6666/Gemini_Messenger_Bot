module.exports.config = {
    ...
    version: "1.0.0",
    hasPermssion: 0,
    credits: "RAKIBUL ISLAM", // তোমার নাম
    description: "Get info about user, group, or admin",
    commandCategory: "Info",
    usages: "user [user|box|admin]",
    cooldowns: 4,
    dependencies: {
        "request": "",
        "fs": ""
